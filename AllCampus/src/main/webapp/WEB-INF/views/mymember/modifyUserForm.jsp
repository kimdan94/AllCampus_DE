...
<div class="page-main">
	...
	<div class="content-main">
		<form action="myPage.do" method="post" id="modify_form">
		<h2>프로필 이미지 변경</h2>
		<ul>
		<li>
		...
		<input type="text" name="mem_nick" id="mem_nick" maxlength="12"
		...
		<h2>학과 설정</h2>
		<h3>주전공 변경</h3>
		<input type="text" name="mem_major" id="mem_major" maxlength="12"
