...
public class BoardReplyVO {
	...
	private String re_modifydate;	//수정일  (1분전..이런거 표시하기 위해 String으로 한다)
	private String re_ip;			//아이피주소
	private int re_anonymous;		//익명 여부
	...
	public int getRe_anonymous() {
		return re_anonymous;
	}
	public void setRe_anonymous(int re_anonymous) {
		this.re_anonymous = re_anonymous;
	}
